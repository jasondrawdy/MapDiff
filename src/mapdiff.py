...
class Analyzer:
    ...
    def compare(self: "Analyzer", original_map_file: str, current_map_file: str, print_to_console: bool = False) -> dict:
        """Checks for data changes between two system map files created using the Pathwalk program written by `Jason Drawdy`.
...
class Program:
    ...
    def _scan(self: "Program"):
        """Begins comparing the differences between two provided system map files generated by the Pathwalk program written by `Jason Drawdy`."""
